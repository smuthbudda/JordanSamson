            ...
            <div className="points-container">
                ...
                <div className="points-grid">
                    <div className="points-grid--select">
                        <div>
                            <h3>Event</h3>
                            <Select className="points-input" options={OutdoorEvents} labelField="Event" placeholder="Event" valueField="Event" onChange={(e) => setEvent(e)} values={OutdoorEvents}/>
                        </div>
                        <div>
                            <h3>Gender</h3>
                            <Select className="points-input" options={GenderArr} labelField="Name" placeholder="Gender" valueField="Value" onChange={(e) => setGender(e)} values={GenderArr}/>
                        </div>
                        <div>
                            <h3>Category</h3>
                            <Select className="points-input" options={Category} labelField="Name" placeholder="Category" valueField="Value" onChange={(e) => setCategory(e)} disabled={true} values={Category}/>
                        </div>
                    </div>
                    ...
                    <div className="points-button--container">
                        ...
                        disabled={(!calcPoints && points != undefined)  }>Calculate</button>
                    </div>
